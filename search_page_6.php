      ...
      'body' => [
       ...
       'size' => 10000,
          'query' => [
              'multi_match' => [
               'query' => $query,
               'fields'=> ['address','neighborhood','council_district']
              ]
          ]
      ]
  ]; 
    ...
    <ul class="pagination"></ul> 
        ...
        <?php
            foreach($response["hits"]["hits"] as $item){
                $searchItem="<li class='result'><a href='' class='name'>".$item["_source"]["address"]." - ".$item["_source"]["neighborhood"]."</a><p class='category'> Manufactured in ".$item["_source"]["council_district"]." <br> No. of Cylinders ".$item["_source"]["council_district"]."<br> <i class='far fa-calendar-alt'></i> ".$item["_source"]["council_district"]."</p><p><i class='fas fa-tachometer-alt'></i> ".$item["_source"]["council_district"]."</p></li>";
                }
            ?>
        </ul>
