...
<i class="fas fa-search" aria-hidden="true"></i>
  ...
  <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Search By Locations" oninput = "onclick()" name = "search2" id="search2" type="submit">
 ...
 echo "<div class='cards' style='margin-bottom:6%;'>";
  for ($i=0; $i<$results_count; $i++)
  {
     echo'
       ...
       <h4><a href="search_results.php?id='.$results[$i]['_source']['pin'].'"id="address">'.$results[$i]['_source']['address'].' '.$results[$i]['_source']['neighborhood'].'</a></h4>
      <br>
       ...
       <b>Council District: </b>'.$results[$i]['_source']['council_district'].' <b>Block Lot: </b>'.$results[$i]['_source']['block_lot'].' <b>Ward: </b>'.$results[$i]['_source']['ward'].'<b>Located</b> in: '.$results[$i]['_source']['pin'].'
       <p class="snippet" id="model_details"> <b><a href="search_results_4.php?id1='.$results[$i]['_id'].'&id2='.$results[$i]['_source']['address'].'"Neighborhood: </b> Save to my Favourites</a></p> <br>
     </div> 
